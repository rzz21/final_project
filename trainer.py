...
from utils.data_utils import get_batch_iterator
...
class Trainer(object):
    ...
    def __init__(self, cfg: FairseqConfig, model, criterion, train_dataset, val_dataset, quantizer=None):
            ...
            try:
                with maybe_no_sync():
                    ...
                    with torch.autograd.profiler.record_function("forward"):
                        with torch.cuda.amp.autocast(enabled=(isinstance(self.optimizer, AMPOptimizer))):
    ...
    def _aggregate_logging_outputs(
        ...
        *extra_stats_to_sum,
        ...
        if self.get_criterion().logging_outputs_can_be_summed():
    ...
    def _reduce_and_log_stats(self, logging_outputs, sample_size, grad_norm=None):
        ...
        with metrics.aggregate() as agg:
            if logging_outputs is not None:
                self.reduce_metrics(logging_outputs, self.get_criterion())
                del logging_outputs
